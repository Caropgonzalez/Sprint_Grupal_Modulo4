...
const mostrarPokemones = document.querySelector('#mostrarPokemones')
...
mostrarPokemones.addEventListener("click", ()=>{
    ...
    mostrarPokemones.style.display = "none";
    cargarMas.style.display = "inline";
    borrarTodo.style.display = "inline";
})
